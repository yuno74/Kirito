...
class Config(object):
    ...
    TOKEN = "1456841492:AAFFet5pIhUi1jx48xTT3yppdEJQLpTbgVk"  #This var used to be API_KEY but it is now TOKEN, adjust accordingly.
    ...
    #RECOMMENDED
    SQLALCHEMY_DATABASE_URI = 'postgres://kirito:123@0.0.0.0:5432/bot'  # needed for any database modules
    LOAD = []
    NO_LOAD = []
    WEBHOOK = False
    INFOPIC = True
