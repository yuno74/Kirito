...
def add_chat(update: Update, context: CallbackContext):
    ...
    if not is_chat:
        ...
        msg.reply_text("🗣️ AI successfully enabled for this chat!")
        message = (
...
__help__ = f"""
Chatbot utilizes the CoffeeHouse API and allows Kirito to talk and provides a more interactive group chat experience.
